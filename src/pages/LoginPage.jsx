...
export default function LoginPage({ onLogin, onGoSignup, onClose }) {
    ...
    >
      <div className="w-full max-w-sm fade-in" onClick={e => e.stopPropagation()}>
        ...
        <div className="relative rounded-2xl p-7"
          ...
          <h1 className="text-lg font-bold mb-6 pr-8" style={{ color: 'var(--c-text)' }}>로그인</h1>
          ...
          <p className="mt-5 text-center text-sm" style={{ color: 'var(--c-text-3)' }}>
            계정이 없으신가요?{' '}
            <button onClick={onGoSignup} className="font-semibold"
